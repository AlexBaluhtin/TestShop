...
internal enum FontFamily {
  internal enum PoetsenOne {
    internal static let regular = FontConvertible(name: "PoetsenOne-Regular", family: "Poetsen One", path: "PoetsenOne-Regular.ttf")
  ...
  internal static let allCustomFonts: [FontConvertible] = [PoetsenOne.all, Roboto.all, SFProDisplay.all, SFProText.all].flatMap { $0 }
